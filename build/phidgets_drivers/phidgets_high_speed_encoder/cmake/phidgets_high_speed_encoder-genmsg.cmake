...
set(MSG_I_FLAGS "-Iphidgets_high_speed_encoder:/home/elliottwhite/proj515_ws/src/phidgets_drivers/phidgets_high_speed_encoder/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/elliottwhite/proj515_ws/src/phidgets_drivers/phidgets_high_speed_encoder/msg/EncoderDecimatedSpeed.msg" NAME_WE)
add_custom_target(_phidgets_high_speed_encoder_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "phidgets_high_speed_encoder" "/home/elliottwhite/proj515_ws/src/phidgets_drivers/phidgets_high_speed_encoder/msg/EncoderDecimatedSpeed.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(phidgets_high_speed_encoder
  "/home/elliottwhite/proj515_ws/src/phidgets_drivers/phidgets_high_speed_encoder/msg/EncoderDecimatedSpeed.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/phidgets_high_speed_encoder)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/phidgets_high_speed_encoder\")")
  # install generated code
  install(
