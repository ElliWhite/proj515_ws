...
echo_and_run cd "/home/elliottwhite/proj515_ws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/elliottwhite/proj515_ws/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
