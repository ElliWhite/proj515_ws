...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/elliottwhite/proj515_ws/src/pid)
  set(pid_DEVEL_PREFIX /home/elliottwhite/proj515_ws/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/elliottwhite/proj515_ws/install)
...
if(NOT "/home/elliottwhite/proj515_ws/devel/include;/home/elliottwhite/proj515_ws/src/pid/include " STREQUAL " ")
  set(pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/elliottwhite/proj515_ws/devel/include;/home/elliottwhite/proj515_ws/src/pid/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/elliottwhite/proj515_ws/src/pid/${idir}'.  ${_report}")
    endif()
